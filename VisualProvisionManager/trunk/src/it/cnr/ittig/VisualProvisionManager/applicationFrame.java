...
import it.cnr.ittig.VisualProvisionManager.Provision.Organization;
...
public class applicationFrame extends JFrame {
	...
	public void createMenu(final applicationFrame frame){
		...
		dutyItem.addActionListener(dutyListener);//creo la toolbar
		...
		/*try{URL location=new URL("C:/a.jpg");
		}
